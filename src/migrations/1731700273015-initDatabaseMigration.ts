...
export class CreatedMigration1731699299249 implements MigrationInterface {
  name = 'CreatedMigration1731699299249';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "favorite" (
        "id" character varying NOT NULL DEFAULT'favorite-singleton-id',
        "artists" uuid array NOT NULL DEFAULT '{}',
        "albums" uuid array NOT NULL DEFAULT '{}',
        "tracks" uuid array NOT NULL DEFAULT '{}',
        CONSTRAINT "PK_495675cec4fb09666704e4f610f" PRIMARY KEY ("id")
      )`,
    );
    await queryRunner.query(
      `INSERT INTO "favorite" ("id", "artists", "albums", "tracks")
      VALUES ('favorite-singleton-id', '{}', '{}', '{}')`,
    );
    await queryRunner.query(
